...
<head>
    <meta charset="utf-8" />
    <title>Allrounder | View Users</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="m-b-30 m-t-0">View Users</h4>
                                        ...
                                        <table id="datatable-buttons" class="table table-stripe table-bordere dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$user->login}}</td>
                                                    <td>{{$user->logout}}</td>
                                                    <td> <a href="{{route('user.edit',['id'=>$user->id])}}"><i class="ti-pencil-alt"></i> Edit</a> <a href="{{route('user.delete',['user'=>$user->id])}}"><i class="ti-trash"></i> Delete</a></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
