                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form method="POST" action="/report/{{$report->id}}/edit">
                                            @method('put')
                                            @csrf
                                        <div class="form-group row">
                                                <label class="col-sm-2 control-label" for="example-text-input">Title of Report</label>
                                                <div class="col-sm-10">
                                                    <input type="text"  value="{{$report->title}}" name="title" class="form-control" placeholder="Missing Pen" id="example-text-input">
                                                </div>
                                        </div>
                                        <textarea name="body"  class="wysihtml5 form-control"  rows="9">{{$report->body}}</textarea><br>
                                        <button type="submit" class="btn btn-primary waves-effect waves-light m-l-10">Edit Report</button>
                                    </div>
                                </div>
                            </div>
                         </form>
